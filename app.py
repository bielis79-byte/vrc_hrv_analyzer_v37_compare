...
st.set_page_config(page_title="VRC / HRV RRi Analyzer Pro v3.7", layout="wide")
...
st.title("VRC / HRV RRi Analyzer Pro v3.7")
st.caption(
...
with tab3:
    ...
    if len(record_data) < 2:
        ...
        if long_df.empty:
            ...
            variable = st.selectbox("Variable principal", available_vars, index=0)

            pivot = pivot_tables[variable]
            if selected_phases:
